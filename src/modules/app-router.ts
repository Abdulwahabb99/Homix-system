    ...
    components: {
      schemas: {
        ...
        FactorySummary: {
          ...
          required: ["id", "code", "name", "address", "responsibleName", "responsiblePhone", "specialty", "statusLabel", "cairoGizaShipping", "otherCitiesShipping", "documentsCount", "website"],
        },
        FactoryDetails: {
          type: "object",
          properties: {
          ...
          required: ["id", "code", "name", "address", "specialty", "statusLabel", "responsible", "bankDetails", "shippingRates", "documents"],
        },
        FactoryMetaResponse: {
          type: "object",
          properties: {
