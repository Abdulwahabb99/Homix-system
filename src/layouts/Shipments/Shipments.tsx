...
export default function Shipments() {
  ...
  const getShipments = (startDateParam, endDateParam) => {
    const shipmentStartIso = startDate && startDateParam ? rangeDateToIso(startDate) : null;
    const shipmentEndIso = endDate && endDateParam ? rangeDateToIso(endDate) : null;
  ...
  const handleReset = () => {
    ...
    setTimeout(() => {
      ...
      getShipments(sp.get("startDate"), sp.get("endDate"));
    }, 300);
  };
