...
> = {
  "تأخير في التوصيل": { bg: "rgba(245,158,11,0.12)", color: "#78350f", dot: "#d97706" },
  "إلغاء": { bg: "rgba(100,100,100,0.10)", color: "#374151", dot: "#6b7280" },
  "استرجاع الأموال": { bg: "rgba(59,130,246,0.12)", color: "#1e40af", dot: "#3b82f6" },
  "استرجاع منتج": { bg: "rgba(139,92,246,0.12)", color: "#5b21b6", dot: "#8b5cf6" },
  "رفض الاستلام": { bg: "rgba(239,68,68,0.12)", color: "#991b1b", dot: "#ef4444" },
  "فشل في التوصيل": { bg: "rgba(244,63,94,0.12)", color: "#9f1239", dot: "#f43f5e" },
  "صيانة": { bg: "rgba(20,184,166,0.12)", color: "#0f766e", dot: "#14b8a6" },
  "استبدال": { bg: "rgba(99,102,241,0.12)", color: "#3730a3", dot: "#6366f1" },
  "التحقق": { bg: "rgba(16,185,129,0.12)", color: "#065f46", dot: "#10b981" },
};

export const DEFAULT_TYPE_COLOR = { bg: "rgba(99,102,241,0.12)", color: "#3730a3", dot: "#6366f1" };
