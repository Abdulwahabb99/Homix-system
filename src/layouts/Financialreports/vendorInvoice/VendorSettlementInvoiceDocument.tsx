      ...
      <div className={styles.paper} ref={ref} dir="rtl" lang="ar">
        ...
        <div className={styles.invHeader}>
          ...
          <div className={styles.invMeta}>
            ...
            <div className={styles.invNumber}>{buildInvoiceNumber(seller.id, cycle)}</div>
        ...
        <div className={styles.invFooter}>
          ...
          <div className={styles.footR}>{VENDOR_INVOICE_FOOTER_NOTE} · {buildInvoiceNumber(seller.id, cycle)} · صفحة 1 من 1</div>
        </div>
      </div>
    </div>
  );
